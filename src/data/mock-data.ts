...
export const mockUsers: User[] = [
  { id: '1', username: 'amartinez', name: 'Ana Martínez', email: 'ana.martinez@example.com', password: '123', role: 'Admin', status: 'Active', avatar: 'https://placehold.co/40x40.png?text=AM', createdAt: subDays(new Date(), 2).toISOString(), registeredBy: 'Admin Panel' },
  { id: '2', username: 'cgomez', name: 'Carlos Gómez', email: 'carlos.gomez@example.com', password: '123', role: 'Editor', status: 'Active', avatar: 'https://placehold.co/40x40.png?text=CG', createdAt: subDays(new Date(), 10).toISOString(), registeredBy: 'Admin Panel' },
  { id: '3', username: 'lfernandez', name: 'Lucía Fernández', email: '', password: '123', role: 'Viewer', status: 'Inactive', avatar: 'https://placehold.co/40x40.png?text=LF', createdAt: subDays(new Date(), 25).toISOString(), registeredBy: 'API' },
  { id: '4', username: 'jdiaz', name: 'Jorge Díaz', email: 'jorge.diaz@example.com', password: '123', role: 'Viewer', status: 'Active', avatar: 'https://placehold.co/40x40.png?text=JD', createdAt: subDays(new Date(), 40).toISOString(), registeredBy: 'Admin Panel' },
  { id: '5', username: 'mbose', name: 'Miguel Bosé', email: '', password: '123', role: 'Editor', status: 'Active', avatar: 'https://placehold.co/40x40.png?text=MB', createdAt: subDays(new Date(), 5).toISOString(), registeredBy: 'API' },
];
...
export const mockTotes: Tote[] = [
    ...
    { id: '101', codigoIdentificacion: 'TOTE-PL-001', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'Con Cliente', ubicacion: 'Cliente', fechaAdquisicion: subDays(new Date(), 50).toISOString(), 
      producto: 'Pulpa de Frutilla', lote: 'L-202405A', clienteId: '201', operadorId: '2', fechaEnvasado: subDays(new Date(), 15).toISOString(), fechaVencimiento: addDays(new Date(), 45).toISOString(), fechaDespacho: subDays(new Date(), 15).toISOString(), notas: `Ruta Santiago` },
    { id: '102', codigoIdentificacion: 'TOTE-AI-002', tipoMaterial: 'Acero Inoxidable', capacidad: 500, unidadCapacidad: 'Kg', estadoActual: 'Disponible', ubicacion: 'Patio de recepción', fechaAdquisicion: subDays(new Date(), 120).toISOString(), operadorId: '4' },
    { id: '103', codigoIdentificacion: 'TOTE-PL-003', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'En Lavado', ubicacion: 'Ken – Lavadora de CIP y COP de totes', fechaAdquisicion: subDays(new Date(), 30).toISOString(), notas: 'Limpieza profunda requerida', operadorId: '5' },
    { id: '104', codigoIdentificacion: 'TOTE-PL-004', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'Con Cliente', ubicacion: 'Cliente', fechaAdquisicion: subDays(new Date(), 40).toISOString(), 
      producto: 'Mermelada de Mora', lote: 'L-202404B', clienteId: '202', operadorId: '2', fechaEnvasado: subDays(new Date(), 35).toISOString(), fechaVencimiento: addDays(new Date(), 25).toISOString(), fechaDespacho: subDays(new Date(), 35).toISOString(), notas: `Ruta Valparaíso` },
    ...
    { id: '106', codigoIdentificacion: 'TOTE-PL-006', tipoMaterial: 'Plástico HDPE', capacidad: 1200, unidadCapacidad: 'Litros', estadoActual: 'Con Cliente', ubicacion: 'Cliente', fechaAdquisicion: subDays(new Date(), 15).toISOString(), 
      producto: 'Pulpa de Manzana', lote: 'L-202405C', clienteId: '204', operadorId: '5', fechaEnvasado: subDays(new Date(), 10).toISOString(), fechaVencimiento: subDays(new Date(), 1).toISOString(), fechaDespacho: subDays(new Date(), 10).toISOString() },
    { id: '107', codigoIdentificacion: 'TOTE-PL-007', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'En Uso', ubicacion: 'Producción (Envasado)', fechaAdquisicion: subDays(new Date(), 45).toISOString(),
      producto: 'Pulpa de Frambuesa', lote: 'L-202405D', fechaEnvasado: new Date().toISOString(), operadorId: '4' },
    ...
    { id: '109', codigoIdentificacion: 'TOTE-AI-009', tipoMaterial: 'Acero Inoxidable', capacidad: 500, unidadCapacidad: 'Kg', estadoActual: 'Disponible', ubicacion: 'Antecámara CALM I', fechaAdquisicion: subDays(new Date(), 180).toISOString(), operadorId: '2' },
    { id: '110', codigoIdentificacion: 'TOTE-PL-010', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'Con Cliente', ubicacion: 'Cliente', fechaAdquisicion: subDays(new Date(), 90).toISOString(), 
      producto: 'Pulpa de Durazno', lote: 'L-202406A', clienteId: '205', operadorId: '4', fechaEnvasado: subDays(new Date(), 20).toISOString(), fechaVencimiento: addDays(new Date(), 40).toISOString(), fechaDespacho: subDays(new Date(), 20).toISOString(), notas: 'Entrega en Rancagua' },
    { id: '111', codigoIdentificacion: 'TOTE-PL-011', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'En Uso', ubicacion: 'Producción (Envasado)', fechaAdquisicion: subDays(new Date(), 90).toISOString(),
      producto: 'Jugo Concentrado Manzana', lote: 'L-202406B', fechaEnvasado: subDays(new Date(), 1).toISOString(), operadorId: '5' },
    ...
    { id: '113', codigoIdentificacion: 'TOTE-AI-013', tipoMaterial: 'Acero Inoxidable', capacidad: 500, unidadCapacidad: 'Kg', estadoActual: 'En Lavado', ubicacion: 'Ken – Lavadora de CIP y COP de totes', fechaAdquisicion: subDays(new Date(), 250).toISOString(), operadorId: '2' },
    ...
    { id: '116', codigoIdentificacion: 'TOTE-PL-016', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'Con Cliente', ubicacion: 'Cliente', fechaAdquisicion: subDays(new Date(), 80).toISOString(),
      producto: 'Pulpa de Frutilla', lote: 'L-202406D', clienteId: '206', operadorId: '4', fechaEnvasado: subDays(new Date(), 5).toISOString(), fechaVencimiento: addDays(new Date(), 55).toISOString(), fechaDespacho: subDays(new Date(), 5).toISOString() },
    ...
    { id: '119', codigoIdentificacion: 'TOTE-PL-019', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'Disponible', ubicacion: 'Antecámara CALM II', fechaAdquisicion: subDays(new Date(), 100).toISOString(), operadorId: '5' },
    { id: '120', codigoIdentificacion: 'TOTE-PL-020', tipoMaterial: 'Plástico HDPE', capacidad: 1000, unidadCapacidad: 'Litros', estadoActual: 'En Uso', ubicacion: 'Producción (Envasado)', fechaAdquisicion: subDays(new Date(), 110).toISOString(),
      producto: 'Jugo de Uva', lote: 'L-202406E', fechaEnvasado: new Date().toISOString(), operadorId: '2' },
    ...
    { id: '122', codigoIdentificacion: 'TOTE-AI-022', tipoMaterial: 'Acero Inoxidable', capacidad: 500, unidadCapacidad: 'Kg', estadoActual: 'Disponible', ubicacion: 'Patio de recepción', fechaAdquisicion: subDays(new Date(), 400).toISOString(), operadorId: '4' },
    { id: '123', codigoIdentificacion: 'TOTE-PL-023', tipoMaterial: 'Plástico HDPE', capacidad: 1200, unidadCapacidad: 'Litros', estadoActual: 'Con Cliente', ubicacion: 'Cliente', fechaAdquisicion: subDays(new Date(), 40).toISOString(),
      producto: 'Pulpa de Manzana', lote: 'L-202406F', clienteId: '206', operadorId: '5', fechaEnvasado: subDays(new Date(), 3).toISOString(), fechaVencimiento: addDays(new Date(), 87).toISOString(), fechaDespacho: subDays(new Date(), 3).toISOString() },
